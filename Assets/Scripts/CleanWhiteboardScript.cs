...
public class CleanWhiteboardScript : MonoBehaviour
{
    IEnumerator AnimC;
    IEnumerator getText;
    ...
    public Animator GDuster;
    public AudioSource audioClip_GDusterA;
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.tag == "Player")
        {
            ...
            GDuster.SetBool("TurnToTalkWB", true);
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.tag == "Player")
        {
            ...
            GDuster.SetBool("TurnToTalkWB", false);
            Background.SetActive(false);
            audioClip_GDusterA.Stop();
    ...
    public void getAudio()
    {
        ...
        audioClip_GDusterA = this.gameObject.GetComponent<AudioSource>();
        audioClip_GDusterA.clip = Resources.Load<AudioClip>(filename);
    }
    ...
    IEnumerator ShowText()
    {
        ...
        getAudio();
        audioClip_GDusterA.Play();
        foreach (string i in updatedSentences)
        {
            newText.text = "<color=green>嘉文:</color>" + i;
            yield return new WaitForSeconds(2);
        }
    ...
    {
        getAudio();
        float timing = audioClip_GDusterA.clip.length;
        yield return new WaitForSeconds(timing);
        GDuster.SetBool("ChangeAni", true);
