...
public class SweepOutsideScript : MonoBehaviour
{
    IEnumerator AnimC;
    IEnumerator getText;
    ...
    public Animator GBroom;
    public AudioSource audioClip_GCloth;
    public AudioSource audioClip_Broom;
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.tag == "Player")
        {
            ...
            GBroom.SetBool("ChangePosition", true);
            dust.Stop();
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.tag == "Player")
        {
            ...
            GBroom.SetBool("ChangePosition", false);
            dust.Play();
            Background.SetActive(false);
            audioClip_GCloth.Stop();
    ...
    public void getAudio()
    {
        ...
        audioClip_GCloth = this.gameObject.GetComponent<AudioSource>();
        audioClip_GCloth.clip = Resources.Load<AudioClip>(filename);
    }

    IEnumerator ShowText()
    {
        getAudio();
        audioClip_GCloth.Play();
        foreach (string i in updatedSentences)
        {
            newText.text = "<color=green>丽华:</color>" + i;
