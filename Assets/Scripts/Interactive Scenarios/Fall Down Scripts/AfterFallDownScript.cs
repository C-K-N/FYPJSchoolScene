...
public class AfterFallDownScript : MonoBehaviour
{
    IEnumerator AnimC;
    IEnumerator getText;
    ...
    public AudioSource audioClip_GFallAfter;
    ...
    public void getAudio()
    {
        ...
        audioClip_GFallAfter = this.gameObject.GetComponent<AudioSource>();
        audioClip_GFallAfter.clip = Resources.Load<AudioClip>(filename);
    }

    IEnumerator ShowText()
    {
        getAudio();
        audioClip_GFallAfter.Play();
